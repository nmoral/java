-- Script d'initialisation PostgreSQL pour le programme d'entraînement Java
...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    type_transaction VARCHAR(20) CHECK (type_transaction IN ('DEPOT', 'RETRAIT', 'VIREMENT')) NOT NULL,
...
CREATE TABLE IF NOT EXISTS emprunts (
    ...
    statut VARCHAR(20) CHECK (statut IN ('EN_COURS', 'RETOURNE', 'EN_RETARD')) DEFAULT 'EN_COURS',
